  ...
  <div class="navbar-wrapper">
    <nav class="navbar navbar-expand-lg">
      <div class="container-fluid">
        ...
        <!-- <button @click="toggleSidebar" type="button" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation"
        ...
        <div class="collapse navbar-collapse justify-content-end">
          ...
          <ul class="navbar-nav ml-auto">
            <li :class="['dropdown nav-item', { show: isDropdownOpen.dropdown1 }]" aria-haspopup="true"
              :aria-expanded="isDropdownOpen.dropdown1">
              <a @click.stop="toggleDropdown('dropdown1')" class="nav-link dropdown-toggle">
                <i class="nc-icon nc-bell-55"></i>
                <span class="notification">5</span>
              </a>
            ...
            <li :class="['dropdown nav-item', { show: isDropdownOpen.dropdown2 }]" aria-haspopup="true"
              :aria-expanded="isDropdownOpen.dropdown2">
